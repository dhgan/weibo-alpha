...
_e(function (E, $) {
    ...
    function linkContentHandler (editor, menu, $linkContent) {
        ...
        $btnSubmit.click(function (e) {
            ...
            var imgHtml = '<img style="max-width: 90%; margin: 10px auto; display: block" src="' + url + '"/>';
    ...
    E.createMenu(function (check) {
        ...
        $btnSubmit.click(function (e) {
            ...
            if(isDynamic){
                ...
                //插入图片
                editor.command(e, 'insertHtml', '<img style="max-width: 90%; margin: 10px auto; display: block;" src="' + src + '"/>', callback);
            }
        });
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        function contentHandle($content) {
            ...
            // 确定按钮
            var codeTpl = '<pre style="max-width: 90%; margin: 10px auto; display: block;overflow-x:auto;"><code{#langClass}>{#content}</code></pre>';
            $btnSubmit.click(function (e) {
                e.preventDefault();
...
_e(function (E, $) {
    ...
    E.createMenu(function (check) {
        ...
        menu.clickEvent = function (e) {
            // 增加样式
            var $editorContainer = editor.$editorContainer;
            $(document.body).addClass("fullScreenBody");
            $editorContainer.siblings(".msgTitle").eq(0).addClass("msgTitleFullScreen");
            ...
            $txt.height(
                ...
                (txtOuterHeight - txtHeight + 40)  // 去掉内边距和外边距
            );
        ...
        menu.clickEventSelected = function (e) {
            // 取消样式
            var $editorContainer = editor.$editorContainer;
            $(document.body).removeClass("fullScreenBody");
            $editorContainer.removeClass('wangEditor-fullscreen');
            $editorContainer.siblings(".msgTitle").eq(0).removeClass("msgTitleFullScreen");
    ...
    E.plugin(function () {
        ...
        fns.onload || (fns.onload = function (resultText, xhr) {
            ...
            if (resultText.indexOf('error|') === 0) {
                ...
                img.onload = function () {
                    var html = '<img src="' + resultText + '" alt="' + originalName + '" style="max-width: 90%; margin: 10px auto; display: block;"/>';
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        function insertImg(src, event) {
            ...
            img.onload = function () {
                var html = '<img src="' + src + '" style="max-width: 90%;width:80%; margin: 10px auto; display: block;"/>';
...
_e(function (E, $) {
    ...
    UploadFile.fn.upload = function (file) {
        ...
        var uploadFileName = editor.config.uploadImgFileName || 'img';
        var onload = uploadImgFns.onload;
        var ontimeout = uploadImgFns.ontimeout;
        var onerror = uploadImgFns.onerror;
...
_e(function (E, $) {
    ...
    E.plugin(function () {
        ...
        var config = editor.config;
        var uploadImgUrl = config.uploadImgUrl;
        var uploadFileName = config.uploadImgFileName || 'img';
        var pasteEvent;
        var $imgsBeforePaste;
